...
export default function Chatbot() {
    ...
    return (
        <div className="bg-gray-900 rounded-lg shadow-lg border border-gray-700 w-full max-w-md overflow-hidden">
            {/* Header */}
            ...
            {/* Messages Container */}
            <div className="h-80 overflow-y-auto p-4 bg-gray-800 space-y-4">
                {messages.length === 0 ? (
